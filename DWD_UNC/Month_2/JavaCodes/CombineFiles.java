...
public class CombineFiles {
	...
	public static void filePreProcess (String source1,String textFile1, int rowStart1, int colStart1, int IDCol1,
	    ...
	    */	   	
	public static void filePostProcess (String sourse1, int colStart1, int IDCol1, String sourse2, String fileNameIn,String fileNameOut)
		 throws IOException {
...
//-----------------------------------------------
	...
	public static void filePostProcess (String sourse1, int colStart1,int IDCol1,String sourse2, double arr[][], int ones[] ,String fileNameOut)
		 throws IOException {
